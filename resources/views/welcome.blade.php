        ...
        <div class="relative lg:max-w-2xl lg:w-screen lg:px-20 ">
          <div class="sm:text-center lg:text-center lg:px-12 py-14">
            ...
            <p class="mt-3 text-base text-blue-900  sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Nosso intuito é fazer da tecnologia nossa aliada na sustentabilidade.
            </p>
          ...
          <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
            <div class="flex">
              <div class="ml-4">
                ...
                <dd class="mt-2 text-base text-white">
                  Queremos fornecer a praticidade para coletar produtos eletrônicos e a facilidade em descartá-los. Assim, esse projeto surgiu com o pensamento de criar um sistema focado 100% em reciclagem. Desse modo, o Reciclatown visa ser um sistema que atenda ambos os usuários, sendo eles coletores ou distribuidores, de maneira rápida e segura.
                </dd>
              </div>
            </div>
            ...
            <div class="flex">
              <div class="ml-4">
                ...
                <dd class="mt-2 text-base text-white">
                  Nosso sistema disponibiliza a inscrição como coletor ou usuário comum. Posto isso, após adentrar ao site é possivel como usuário comum cadastrar produtos para descarte ou como coletor vizualizar os produtos disponíveis e agendar a retirada com o usuário que está fornecendo o produto. Viu? De modo simples e prático o Reciclatown conecta coletores e doadores fazendo da tecnologia aliada na sustentabilidade.
                </dd>
              </div>
            </div>
            ...
            <div class="flex">
              <div class="ml-4">
                ...
                <dd class="mt-2 text-base text-white">
                  Materiais como placas de circuitos, entre outros, possuem quantidades significativas de mercúrio, chumbo e cádmio, metais estes que são altamente poluentes e que afetam tanto na qualidade do solo como da água. Portanto, o Reciclatown por meio de poucos cliques te ajuda a descartar adequadamente ou coletar qualquer eletrônico para reutilização ou qualquer outro objetivo. 
                </dd>
              </div>
            </div>
          </dl>
          ...
          <div class="mt-10">
            <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-4 md:gap-x-8 md:gap-y-10">
              <div class="flex-shrink-0">
                <div class="ml-4">
                  <dt class="text-lg sm:text-center leading-6 font-medium text-white">mais produziu lixo eletrônico em 2019</dt>
                  <dd class="mt-2 text-3x1 text-blue-900 sm:text-4xl sm:text-center">5º País</dd>
                </div>
              </div>
              ...
              <div class="flex-shrink-0">
                <div class="ml-4">
                  <dt class="text-lg sm:text-center leading-6 font-medium text-white">Lixo eletrônico coletado e reciclado em 2019</dt>
                  <dd class="mt-2 text-3x1 text-white sm:text-4xl sm:text-center">17,4%</dd>
                </div>
              </div> 
            </dl>
          </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="lg:text-center">
            ...
            <div class="p-4 relative">
              <div class="mb-32 flex items-center flex-col md:flex-row justify-center evenly">
                <div class="p-4 relative">
            ...
            <!--outra linha-->
             <div class="flex items-center flex-col md:flex-row justify-center evenly">
              <!--Eduardo-->
          <div class="p-4 relative">
            <div class="text-center mb-4 absolute -top-16 right-1/2 transform translate-x-1/2">
              <a href="#" class="block relative">
